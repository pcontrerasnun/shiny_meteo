...
DailyTmeanPlot <- function(data, selected_year, ref_start_year, ref_end_year, max_date) {
  ...
  p <- ggplot2::ggplot(data = plot_data, aes(x = date)) +
    ...
    ggplot2::scale_fill_manual(
      ...
      labels = c("P100" = expr(paste("Very hot (", italic(P[80]), " - ", italic(P[100]), ") (", 
                                     !!ref_start_year, " - ", !!ref_end_year, ")")), 
                 "P80" = expr(paste("Hot (", italic(P[60]), " - ", italic(P[80]), ") (", 
                                    !!ref_start_year, " - ", !!ref_end_year, ")")), 
                 "P60" = expr(paste("Normal (", italic(P[40]), " - ", italic(P[60]), ") (", 
                                    !!ref_start_year, " - ", !!ref_end_year, ")")),
                 "P40" = expr(paste("Cold (", italic(P[20]), " - ", italic(P[40]), ") (", 
                                    !!ref_start_year, " - ", !!ref_end_year, ")")),
                 "P20" = expr(paste("Very cold (", italic(P[00]), " - ", italic(P[20]), ") (", 
                                    !!ref_start_year, " - ", !!ref_end_year, ")"))),
    ...
    ggplot2::labs(
      ...
      subtitle = paste0(
        "Daily mean temperature vs. historical values (", ref_start_year, " - ", ref_end_year, ")"),
